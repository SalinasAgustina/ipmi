...
void setup() {
  ...
  imagenP1 = loadImage("fortnite.jpg");
  imagenP2 = loadImage("victoryroyale.jpg");
  imagenP3 = loadImage("mododejuego.jpg");
  boton = loadImage("boton.jpg");
  
  //Fuentes para las pantallas
  fuenteP1 = loadFont("Cambria-BoldItalic-48.vlw");
  fuenteP2 = loadFont("Constantia-Bold-48.vlw");
...
void draw() {
  ...
  if (segundos <= 5) {
    ...
    fill(255);
    text("Fortnite es un videojuego multijugador en línea \ndesarrollado por Epic Games", 320, movimientoYTextoP1);
    ...
    fill(255);
    text("donde hasta 100 jugadores compiten en un mapa \npara ser el último en pie", 320, 30);
   ...
   escaladoTextoP2 = escaladoTextoP2 + 0.1;
    ...
    textAlign(CENTER, CENTER);
    text("Fortnite ofrece tres modos de juego: Salvar el Mundo, Battle Royale y Modo Creativo", 320, 45);
